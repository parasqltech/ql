                                   ...
                                   <ul className="">
                                       <li className="">
                                           <a href="services-main-page.html" className="dropdown-item">
                                               <span className="services-heading">Strategy &amp; Consulting</span>
                                               <span className="services-description">Deep-dive into a structured framework to plan and execute your business objectives</span>
                                           </a>
                                       </li>
                                       <li className="">
                                           <a href="services-main-page.html" className="dropdown-item">
                                               <span className="services-heading">Agile-focused Development</span>
                                               <span className="services-description">Respond to new challenges and expectations in a flexible and swift manner. Build strong digital assets.</span>
                                           </a>
                                       </li>
                                       <li className="">
                                           <a href="services-main-page.html" className="dropdown-item">
                                               <span className="services-heading">CRM Consulting and Development</span>
                                               <span className="services-description">Discover possibilities to amplify your business with CRM. Automate your process, sales and marketing. </span>
                                           </a>
                                       </li>
                                       <li className="">
                                           <a href="services-main-page.html" className="dropdown-item">
                                               <span className="services-heading">Inbound Methodology</span>
                                               <span className="services-description">Embrace a method of attracting, engaging, and delighting your clients that provides value, and builds trust.</span>
                                           </a>
                                       </li>
                                       <li className="">
                                           <a href="services-main-page.html" className="dropdown-item">
                                               <span className="services-heading">Analytics & Reporting</span>
                                               <span className="services-description">Analyze data that you can trust to derive insights and accelerate your business.</span>
                                           </a>
                                       </li>
