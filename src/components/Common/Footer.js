                        ...
                        <div className="col-md-12 text-center">
                             <h6 className="text-white h4 mb-3">Follow us on</h6>
                                <ul className="footer-social-links social-bookmark">
                                    <li><a href="https://www.facebook.com/QLTechAU/" target="_blank"><i
                                                className="fa fa-facebook"></i></a></li>
                                    <li><a href="https://twitter.com/qltechaustralia" target="_blank"><i
                                                className="fa fa-twitter"></i></a></li>
                                    <li><a href="https://www.linkedin.com/company/qltechau" target="_blank"><i
                                                className="fa fa-linkedin"></i></a></li>
                                    <li><a href="https://www.instagram.com/qltechau/" target="_blank"><i
                                                className="fa fa-instagram"></i></a></li>
                                    <li><a href="https://www.quora.com/profile/QL-Tech-Australia" target="_blank"><i
                                                className="fa fa-quora">Q</i></a></li>
                                </ul>
                        </div>
                    </div>
            </div>
